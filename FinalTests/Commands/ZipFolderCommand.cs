...
{
    public class ZipFolderCommand(IIOWrapper wrapper, IZipperExecutor executor) : ICommand
    {
        public bool Continue => true;
        public async void Execute()
        {
            wrapper.OutValue("Enter full path to source folder");
            ...
            IPathExecutor zipper = new DirectoryZipper(pathFrom, pathTo, compressionLevel);
